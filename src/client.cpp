...
public:
    TextUpdateClient(std::shared_ptr<Channel> channel)
        : stub_(TextUpdateService::NewStub(channel)) {}
...
int main(int argc, char** argv) {
    TextUpdateClient client(grpc::CreateChannel("localhost:50051", grpc::InsecureChannelCredentials()));
